...
export default class Third extends Component {
  ...
  render() {
    const dropdown_6_icon = this.state.dropdown_6_icon_heart ? require('../assets/images/jahad.png') : require('../assets/images/jahad.png');
    return (
  ...
  _dropdown_2_renderRow(rowData, rowID, highlighted) {
    let icon = highlighted ? require('../assets/images/heart.png') : require('../assets/images/flower.png');
    let evenRow = rowID % 2;
    return (
